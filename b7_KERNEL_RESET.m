...
for id = 1:length(par.inv.datatypes)
    ...
    if strcmp(pdtyp{2},'HV')
        ...
        K = run_kernels(phV, grV, predata.(dtype).for_mod_info.periods_calc, ...
            par_mineos,SW_precise.(pdtyp{2}).eigfiles, MINEOS_file_delete, ifplot, par.inv.verbose); %MINEOS_REPLACE
