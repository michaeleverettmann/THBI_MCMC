...
[stf_ps,tt_ps] = run_propmat_or_telewavesim(par.synth.propmat_or_telewavesim,onelayin,'mrfunc','Ps',par.synth.samprate, 0.1, [], par.forc.synthperiod,par.forc.nsamps);
