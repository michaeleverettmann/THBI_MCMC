...
c
 101  format(a80)
      ...
      rewind 3
C     First line of infile is number of frequencies
      read(3,*)nfq
C     now each individual freq gets its own line
      do i=1,nfq
      read(3,*)frqs(i)
      enddo
C     Next line of infile is knot description 
      read(3,*)dh,ncase0
C     Next line of infile is number of layers in input model 
      read(3,*)nlay0
      do i=1,nlay0
...
C     fstop=0.37d0
C     dfq=0.01d0
C     nfq=(fstop-fstart)/dfq+1.1
c
      write(6,780)nfq
  780 format(I4,' frequencies')
c
...
c-------------------------------------------------------------------------
      ...
      implicit real*8(a-h,o-z)
      common /struc2/ r2(50000),h2(50000),rho2(50000),vp2(50000),
     2 vs2(50000),qp2(50000), qs2(50000), nlay2, nlay
