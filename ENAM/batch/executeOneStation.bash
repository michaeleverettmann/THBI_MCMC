...
#SBATCH --cpus-per-task=16 # bb2021.11.17 I think there is one task for each par for iteration, taking one full CPU. Might have to adjust this. 
#SBATCH --time=5:00:00   # bb2021.11.17 Might have to refine this, just to make sure a failed run will be terminated at a decent time.             # Time limit hrs:min:sec
