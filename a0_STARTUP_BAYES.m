...
global pathstimeout pathsPropMat pathsCADMINEOS % Some special paths which you list here once. When transferring this code to another computer, change the path accordingly here and only here. 
...
%                    'timeout', '/usr/local/bin/timeout'); In parallel, matlab does not pass global structures, it just gives empty variables. 
pathsCADMINEOS = '/Users/brennanbrunsvik/Documents/repositories/Peoples_codes/CADMINEOS'; 
pathsPropMat = '/Users/brennanbrunsvik/Documents/repositories/Peoples_codes/PropMat'; 
pathstimeout = '/usr/local/bin/timeout'; 
