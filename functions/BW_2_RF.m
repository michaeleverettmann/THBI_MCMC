    ...
    %=================================%
        ...
        elseif strcmp(RFparms.method,'IDRF')
            ...
            [tt_RFp, RFp]=IDRF(Parent',Parent',...
                           1./trudata.(trudtypes{idt}).samprate,... % dt
                           minmax(trudata.(trudtypes{idt}).tt')',RFparms.gauss_t,... % bb2021.09.13 minmax was giving two full vectors, rather than one minimum and one maximum value. I added two transposes here to fix it. 
