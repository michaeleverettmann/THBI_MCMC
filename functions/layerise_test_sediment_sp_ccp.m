...
% This was a test of removing(?) sediment for Sp receiver functions. I
% think it will not be in use now, but the function is kept in case the
% test is redone. brb~2022
