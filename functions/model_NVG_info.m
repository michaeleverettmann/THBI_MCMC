...
if isfield(model,'VSav')
    ...
    z = model.z;
    Vs = model.VS; % bb2021.09.13 Here Jon has Vs... 
    zmoh = model.zmoh;
end
% =======
% z = model.z; % bb2021.09.13 Brennan changing from model.Z to model.z. It seems like Jon has .Z, and maybe some of Zach's old code is .Z, but most of the model.z references in other codes are model.z. And there is no model.Z, only model.z. 
% Vs = model.VSav;
% zmoh = model.Zd(2).mu;
