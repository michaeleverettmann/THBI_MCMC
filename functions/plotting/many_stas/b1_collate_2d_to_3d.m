% % brb2023/04/17 This was taken directly from b1_plot_sage_gage.m. Goal is
% % to make a 3-d file that can be used by Python and Plotly. 
% EDIT pausing on this, try saving file directly from b1_plot-...
% Because then I have information like where are the cross-sections. 
% 
% clc; clear; 
