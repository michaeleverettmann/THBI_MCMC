...
if isempty(options.posterior); % Have to calculate averages from 1-D profile. 
    xi = model.Sanis/100+1; % Radial S anisotropy. add one because for some reason here anisotropy is + or -
...
% Receiver functions making HK stack for each rf? Or just 1? 
